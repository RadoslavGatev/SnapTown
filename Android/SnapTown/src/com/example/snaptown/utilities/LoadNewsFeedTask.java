...
public class LoadNewsFeedTask extends AsyncTask<String, Void, List<Media>> {
	...
	public LoadNewsFeedTask(ProgressBar loadProgress,
	...
	protected List<Media> doInBackground(String... params) {
		List<Media> media = MediaClient.getNewsFeed(params[0]);
		return media;
	}
}